...
import (
	...
	"github.com/zhigui-projects/zeus-onestop/starport/pkg/cosmosfaucet"
	"github.com/zhigui-projects/zeus-onestop/starport/pkg/fswatcher"
			...
			case <-c.serveRefresher:
				...
				case errors.As(err, &buildErr):
					...
					if errors.As(err, &validationErr) {
						fmt.Fprintln(c.stdLog(logStarport).out, "see: https://github.com/zhigui-projects/zeus-onestop#configure")
					}

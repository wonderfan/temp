...
var (
	...
	ErrCouldntLocateConfig = errors.New("could not locate a config.yml in your chain. please follow the link for how-to: https://github.com/zhigui-projects/zeus-onestop/blob/develop/docs/1%20Introduction/4%20Configuration.md")
